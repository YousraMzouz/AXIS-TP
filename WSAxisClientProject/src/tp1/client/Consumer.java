...
import tp1.stub.Account_managerStub.CreateAccount;
import tp1.stub.Account_managerStub.CreateAccountResponse;

public class Consumer {
	
	public static void main(String[] args) throws Exception {
		
		Account_managerStub stub = new
				Account_managerStub("http://localhost:8080/axis2/services/account_manager");
